...
* Marcar tareas como completadas o reactivarlas.
* Eliminar tareas.
* Filtrar por: Todas, Activas, Completadas.
* Contador de estadísticas: total, completadas y activas.
...
```bash
git clone https://github.com/p4sh3/vanilla-to-do-list.git
...
* **`main.js`**: es el único punto donde se instancian y conectan todas las dependencias.
...
* Eliminación de duplicación: lógica de filtrado, guardado y renderizado centralizada en un solo lugar.
